...
const Filters = ({onClickFilter} : {
    ...
    const diffDates = (fecha: Date|string) => {
        ...
        return Math.round(((d.getTime() - today.getTime()) / msPerDay) + 1);
    }
            ...
            <div className="bg-white rounded-lg shadow-lg w-1/2 max-w-2xl p-6 z-10 ">
                ...
                <form onSubmit={(e) => {
                    ...
                    <div className="flex gap-2 mb-4">
                        <input name="start" type="date" className="border p-2 rounded w-1/2 " />
                        <input name="end" type="date" className="border p-2 rounded w-1/2 " />
                    </div>
